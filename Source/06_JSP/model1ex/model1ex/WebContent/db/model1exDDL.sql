...
CREATE TABLE FILEBOARD(
    ...
    CID VARCHAR2(50) REFERENCES CUSTOMER(CID), -- 작성자CID
    FSUBJECT VARCHAR2(250) NOT NULL, -- 글제목
    FCONTENT VARCHAR2(4000), -- 본문
    FFILENAME VARCHAR2(50), -- 첨부파일명
    FPW VARCHAR2(50) NOT NULL, -- 삭제 할 때 써야해서.
    FHIT NUMBER(7) DEFAULT 0 NOT NULL , -- 조회수 READCOUNT
    FREF NUMBER(7) NOT NULL, -- 글 그룹
    FRE_STEP NUMBER(7) NOT NULL, -- 그룹 내 출력 순서
