...
INSERT INTO CUSTOMER (CID, CPW, CNAME, CTEL, CEMAIL, CADDRESS, CGENDER, CBIRTH) 
    VALUES ('aaa','111','홍길동','010-9999-9999', 'aaa@naver.com', '서울시 용산구','m','1991-01-01');
    
    
-- 2. 도서(BOOK) 테이블 DUMMY DATA
...
-- 3. 파일첨부게시판(FILEBOARD) 테이블 DUMMY DATA
