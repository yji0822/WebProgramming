...
<body>
	...
	<%
		Enumeration<String> names = session.getAttributeNames(); // 속성 이름들 받아온 배열
		int cnt = 0;
		...
		if(cnt == 0) {
			...
			out.println("<button onclick=\"locarion.href='login.jsp'\">로그인</button>");
		} else {
			out.println("<button onclick=\"locarion.href='logout.jsp'\">로그아웃</button>");
		}
	%>
