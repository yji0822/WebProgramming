...
public class BoardDtoAgain {
	...
	public BoardDtoAgain() {}

	public BoardDtoAgain(int num, String writer, String subject, String content, String email, int readcount, String pw,
	...
	public String toString() {
		return "BoardDtoAgain [num=" + num + ", writer=" + writer + ", subject=" + subject + ", content=" + content
