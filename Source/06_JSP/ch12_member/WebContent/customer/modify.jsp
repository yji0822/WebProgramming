...
<body>
<%! String cid, cpw, cname, ctel, cemail, caddress, cgender, cbirth; %>
<%
	...
	if(customer==null){
		...
		cbirth = customer.getCbirth().toString();
	}
%>
		...
		<form action="modifyPro.jsp" method="post" name="frmJoin" onsubmit="return chkJoinInfo()">
			...
			<table>
				...
				<tr>
					...
					<td><input type="date" name="tempbirth" id="cbirth" required="required" value="<%=cbirth%>"></td>
				</tr>
				<tr>
					<th>성별</th>
					<td>
